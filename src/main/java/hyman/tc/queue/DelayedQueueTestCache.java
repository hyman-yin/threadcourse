...
/**
 * 利用DelayQueue实现自动缓存
 * @author https://www.cnblogs.com/sunzhenchao/p/3515085.html
 *
 */
public class DelayedQueueTestCache<K, V> {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int cacheNumber = 10;
        int liveTime = 0;
        DelayedQueueTestCache<String, Integer> cache = new DelayedQueueTestCache<String, Integer>();
